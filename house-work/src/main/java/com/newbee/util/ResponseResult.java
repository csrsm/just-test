...
public class ResponseResult implements Serializable{
    ...
    public static ResponseResult build(HttpStatus status, Object data) {
        return new ResponseResult(status.value(), status.getReasonPhrase(), data);
    }
    ...
    public static ResponseResult build(BindingResult result) {
        return ResponseResult.build(HttpStatus.BAD_REQUEST.value(),
                result.getFieldError().getDefaultMessage(), result.getFieldErrors());
    }
}
